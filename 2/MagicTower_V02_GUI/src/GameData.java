...
public class GameData implements Serializable {
	...
	void printMap() {
		...
		if(bleeding == true){
			if(count>0){
				System.out.print(
						"*STEEL SOUL Mode*    Healing Duration: "+count +"   Health:" + Integer.toString(heroHealth) + "  KeyNum:" + Integer.toString(keyNum) + "  Menu:press 0\n");
			}else{
				System.out.print(
						"*STEEL SOUL Mode*  !bleeding!  Health:" + Integer.toString(heroHealth) + "  KeyNum:" + Integer.toString(keyNum) + "  Menu:press 0\n");
			}
